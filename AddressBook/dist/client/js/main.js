    ...
    !function (global, factory) {
        ...
        jQuery.event = {
            global: {}, add: function (elem, types, handler, data, selector) {
                ...
                if (elemData && (events = elemData.events)) {
                    for (types = (types || "").match(rnothtmlwhite) || [""], t = types.length; t--;)if (tmp = rtypenamespace.exec(types[t]) || [], type = origType = tmp[1], namespaces = (tmp[2] || "").split(".").sort(), type) {
        ...
        jQuery.fn.extend({
            ...
            addClass: function (value) {
                ...
                if ("string" == typeof value && value)for (classes = value.match(rnothtmlwhite) || []; elem = this[i++];)if (curValue = getClass(elem), cur = 1 === elem.nodeType && " " + stripAndCollapse(curValue) + " ") {
            ...
            valHooks: {
                option: {
                    ...
                    get: function (elem) {
                        ...
                        for (i = index < 0 ? max : one ? index : 0; i < max; i++)if (option = options[i], (option.selected || i === index) && !option.disabled && (!option.parentNode.disabled || !jQuery.nodeName(option.parentNode, "optgroup"))) {
        ...
        }), jQuery.parseJSON = JSON.parse, "function" == typeof define && define.amd && define("npm:jquery@3.1.1/dist/jquery.js", [], function () {
            return jQuery
...
}(), System.registerDynamic("github:twbs/bootstrap@3.3.7/js/bootstrap.js", ["jquery"], !1, function ($__require, $__exports, $__module) {
...
}), System.registerDynamic("github:twbs/bootstrap@3.3.7.js", ["github:twbs/bootstrap@3.3.7/js/bootstrap.js"], !0, function ($__require, exports, module) {
    this || self;
    return module.exports = $__require("github:twbs/bootstrap@3.3.7/js/bootstrap.js"), module.exports
}), System.registerDynamic("npm:core-js@1.2.7/library/modules/$.js", [], !0, function ($__require, exports, module) {
...
}), System.registerDynamic("npm:core-js@1.2.7/library/fn/object/define-property.js", ["../../modules/$"], !0, function ($__require, exports, module) {
    var $ = (this || self, $__require("../../modules/$"));
    return module.exports = function (it, key, desc) {
        return $.setDesc(it, key, desc)
    }, module.exports
}), System.registerDynamic("npm:babel-runtime@5.8.38/core-js/object/define-property.js", ["core-js/library/fn/object/define-property"], !0, function ($__require, exports, module) {
    this || self;
    return module.exports = {
        default: $__require("core-js/library/fn/object/define-property"),
        __esModule: !0
    }, module.exports
}), System.registerDynamic("npm:babel-runtime@5.8.38/helpers/create-class.js", ["../core-js/object/define-property"], !0, function ($__require, exports, module) {
    "use strict";
    var _Object$defineProperty = (this || self, $__require("../core-js/object/define-property").default);
...
}), System.registerDynamic("npm:babel-runtime@5.8.38/helpers/class-call-check.js", [], !0, function ($__require, exports, module) {
    "use strict";
    this || self;
    return exports.default = function (instance, Constructor) {
        if (!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")
    }, exports.__esModule = !0, module.exports
}), System.register("js/horloge.js", ["npm:babel-runtime@5.8.38/helpers/create-class.js", "npm:babel-runtime@5.8.38/helpers/class-call-check.js"], function (_export) {
    var _createClass, _classCallCheck, Horloge, Contact;
    return {
        setters: [function (_babelRuntimeHelpersCreateClass) {
            ...
            Horloge = function () {
                function Horloge(container) {
                    _classCallCheck(this, Horloge), this.container = container, this.update(), setInterval(this.update.bind(this), 1e3)
                }

                return _createClass(Horloge, [{
                    key: "update", value: function () {
                        var now = new Date;
                        this.container.innerHTML = now.getHours() + "h" + now.getMinutes() + "m" + now.getSeconds()
                    }
                }]), Horloge
            }(), _export("Horloge", Horloge), Contact = function () {
                function Contact(prenom) {
                    _classCallCheck(this, Contact), this.prenom = prenom
                }

                return _createClass(Contact, [{
                    key: "hello", value: function () {
...
}), System.register("js/main.js", ["jquery", "bootstrap", "./horloge"], function (_export) {
    "use strict";
    var $, bootstrap, Horloge, navbarBrand, horloge;
    return {
        setters: [function (_jquery) {
            ...
            Horloge = _horloge.Horloge
        }], execute: function () {
            navbarBrand = document.querySelector(".navbar-brand"), horloge = new Horloge(navbarBrand), horloge.update()
        }
    }
});
